...
frame_count = 0
save_frame_interval = 6  # 프레임마다 저장

input_plate_number = "29호8327"  # 정답 번호
total_img = 1
# start_image = total_img
# max_images = 15
false_num = 0
true_num = 0
accuracy = 0
                ...
                if plate_texts:
                    ...
                    if plate_text_build:
                        ...
                        if frame_count % save_frame_interval == 0:
                            ...
                            accuracy = (true_num / total_img) * 100  
                            print(f"true : {true_num}장,  false : {false_num}")
                            print("현재 정확률 :", accuracy)
...
# 저장할 문장
sentence = f"number is {input_plate_number} \ntrue : {true_num}장,  false : {false_num}\n 정확률 :{accuracy}"

# 파일 열기 (쓰기 모드)
with open(file_path, 'w', encoding='utf-8') as file:
    file.write(sentence)  # 문장 쓰기

# 파일이 자동으로 닫힙니다.
print(f"문장이 '{file_path}'에 저장되었습니다.")