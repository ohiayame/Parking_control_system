...
def preprocess_image(image):
    ...
    # 画像のノイズを除去
    # clean_image = image.filter(ImageFilter.MedianFilter())
...
def recognize_text(image_path):
        ...
        text = pytesseract.image_to_string(preprocessed_image, lang='kor+eng', config=custom_config)
        print(text)
...
# 나다라마거너더러머버서어저고노도로모보소오조구누두루무부수우주아바사자하허호배
